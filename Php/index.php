...
<body>
<h1>Kopi Finansial - Pengatur Keuangan Anda<br>
<img src="gambar_keuangan.png" alt="gambar keuangan" 
style="vertical-align: middle; width: 300px; height: 300px;"></h1>
    ...
    <form method="post" action="proses_barang.php">
        ...
        Harga Barang: <input type="number" name="harga_barang" min="0" step="1"><br>
        <!-- Input harga barang dalam Rupiah -->
